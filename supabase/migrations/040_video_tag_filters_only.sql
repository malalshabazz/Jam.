-- Role filters must match video tags only, never profile creator_types.
-- (A DJ who posts an untagged singing clip should not appear under DJ.)

drop function if exists public.video_role_tags(text[], text[], text[]);
