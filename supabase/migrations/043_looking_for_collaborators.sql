-- Looking-for-collaborators tag on videos + feed RPC filters.

alter table public.videos
  add column if not exists looking_for boolean not null default false;

comment on column public.videos.looking_for is
  'True when the creator tagged this post as looking for collaborators.';
