...
export function getChromeIconColor(active = true) {
  if (activeThemeMode === "light") return active ? "#0a0a0a" : "#71717a";
  return active ? "#fff" : "#d4d4d8";
}
...
const baseStyles = {
  ...
  destructiveButtonText: { color: danger, fontSize: 16, fontWeight: "800", textTransform: "lowercase" },
  ...
  confirmOptionDangerText: { color: danger, fontSize: 16, fontWeight: "800", textTransform: "lowercase" },
  ...
  jamLimitReachedText: { color: danger },
  loader: { marginTop: 28 },
  ...
  notificationChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, borderWidth: 1, borderColor: border, backgroundColor: panel },
  notificationChipText: { color: "#e4e4e7", fontSize: 14 },
  ...
  profileMenuDangerText: { color: danger, fontSize: 15, fontWeight: "800", textTransform: "lowercase" },
  ...
  feedMoreMenuDangerText: { color: danger, fontSize: 15, fontWeight: "800", ...overlayTextShadow },
  ...
  ownVideoActionDanger: { color: danger },
  ownVideoActionBadge: {
  ...
  ownVideoSheetDismiss: { ...StyleSheet.absoluteFillObject },
  ownVideoSheetCard: {
  ...
  videoMenuDangerText: { color: danger, fontSize: 15, fontWeight: "800", textTransform: "lowercase", ...overlayTextShadow },
  ...
  createChooseOptionTitle: {
    color: "#fff",
    fontSize: 20,
    fontWeight: "700",
    letterSpacing: -0.3,
  },
  createChooseOptionHelper: {
    color: "#a1a1aa",
    fontSize: 14,
    lineHeight: 20,
  },
  createSlideshowImageRow: {
    marginVertical: 8,
    maxHeight: 88,
  },
  createSlideshowThumb: {
    width: 72,
    height: 72,
    borderRadius: 10,
    marginRight: 8,
  ...
  createEditAudioButton: {
    ...
    borderRadius: CREATE_CAMERA_CONTROL_BUTTON_SIZE / 2,
    backgroundColor: "#3f3f46",
    alignItems: "center",
    justifyContent: "center",
  },
  ...
  messageContextDangerText: { color: danger, fontSize: 15, fontWeight: "800", textTransform: "lowercase" },
  ...
  logoutText: { color: danger, fontSize: 15, textTransform: "lowercase" },
